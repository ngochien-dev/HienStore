...
// // log.info("Default admin account created successfully. Username: admin /
// Password: admin123");
// // }
// // }
// // }
...
// } catch (Exception e) {
// // Nếu có lỗi (như trùng email), catch tại đây để app vẫn khởi động bình
// thường
// log.error("Failed to seed admin account, maybe it already exists: {}",
// e.getMessage());
// }
// } else {
